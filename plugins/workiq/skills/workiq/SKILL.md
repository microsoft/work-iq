...
| "Copy file to folder" | `fetch` to find file and target folder | Show source item and destination folder; wait for confirmation | `do_action` `/drives/{driveId}/items/{id}/copy`; verify response |
