...
Public additional domains: [SharePoint search](sharepoint-work-iq.md) and
[Business Applications](business-applications.md), including discovery,
environment queries, record file operations, and intentional `execute-work`.
