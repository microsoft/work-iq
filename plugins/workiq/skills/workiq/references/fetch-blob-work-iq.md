...
The public [SharePoint owner](sharepoint-work-iq.md) retains site/library and
explicit site-page resolution. Use only supported binary routes for calendar
attachments or profile photos; their existence must not be guessed from mail
examples.
